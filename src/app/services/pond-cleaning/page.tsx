...
const service = servicesData.find((s) => s.slug === "pond-cleaning")!;
const relatedProject = projectsData.find((p) => p.id === "la-fitness-entry-fountain");

export const metadata: Metadata = constructMetadata({
  title: `${service.title} | Orange County Pond Cleanouts & Ecosystem Care`,
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 space-y-12">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Pond Health Benefits</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Seasonal Cleanout Steps</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Common Pond Ecosystem Problems</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-28 bg-navy-900 text-white p-6 sm:p-8 rounded-2xl border border-navy-800 shadow-xl space-y-6">
                <div className="flex items-center gap-2 text-xs font-bold text-aqua-400 uppercase tracking-wider">
                  ...
                  <span>Fish-Safe Procedures</span>
                </div>

                <h3 className="text-xl font-bold text-white leading-snug">
                  Schedule Your Pond Cleanout
                </h3>

                <p className="text-xs sm:text-sm text-slate-300">
                  Protect your koi and keep pond water clear all year long.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <PhoneCallLink
                    locationLabel="sidebar-pond-cleaning"
