...
export default function FountainRepairPage() {
  return (
    <>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 space-y-12">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Diagnostic & Repair Process</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Common Fountain Failures We Fix</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-28 bg-navy-900 text-white p-6 sm:p-8 rounded-2xl border border-navy-800 shadow-xl space-y-6">
                ...
                <h3 className="text-xl font-bold text-white leading-snug">
                  Is Your Fountain Stopped or Leaking?
                </h3>

                <p className="text-xs sm:text-sm text-slate-300">
                  Contact our technicians for rapid troubleshooting and transparent repair options.
                </p>
