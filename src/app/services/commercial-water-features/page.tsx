...
const service = servicesData.find((s) => s.slug === "commercial-water-features")!;
const relatedProject = projectsData.find((p) => p.id === "bella-terra-commercial-fountain");

export const metadata: Metadata = constructMetadata({
  title: `${service.title} | HOA & Plaza Water Maintenance SoCal`,
  description: service.shortDescription,
  canonical: `/services/${service.slug}`
});

export default function CommercialWaterFeaturesPage() {
  return (
    <>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 space-y-12">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Commercial Property Benefits</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Commercial Service Workflow</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Commercial Challenges Solved</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-28 bg-navy-900 text-white p-6 sm:p-8 rounded-2xl border border-navy-800 shadow-xl space-y-6">
                <div className="flex items-center gap-2 text-xs font-bold text-aqua-400 uppercase tracking-wider">
                  ...
                  <span>HOA & Property Managers</span>
                </div>
                ...
                <p className="text-xs sm:text-sm text-slate-300">
                  Customized scheduled visits, digital service logging, and emergency priority response.
                </p>
