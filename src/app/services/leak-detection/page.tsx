...
const service = servicesData.find((s) => s.slug === "leak-detection")!;
const relatedProject = projectsData.find((p) => p.id === "water-feature-leak-repair-laguna");

export const metadata: Metadata = constructMetadata({
  title: `${service.title} | Orange County Water Feature Leak Testing & Sealing`,
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 space-y-12">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Benefits of Professional Leak Isolation</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Leak Detection Methodology</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Signs You Have a Water Loss Leak</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-28 bg-navy-900 text-white p-6 sm:p-8 rounded-2xl border border-navy-800 shadow-xl space-y-6">
                <div className="flex items-center gap-2 text-xs font-bold text-aqua-400 uppercase tracking-wider">
                  ...
                  <span>Precision Isolation</span>
                </div>

                <h3 className="text-xl font-bold text-white leading-snug">
                  Losing Water Rapidly?
                </h3>

                <p className="text-xs sm:text-sm text-slate-300">
                  Prevent utility bill spikes and foundation damage with our expert leak detection service.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <PhoneCallLink
                    locationLabel="sidebar-leak-detection"
