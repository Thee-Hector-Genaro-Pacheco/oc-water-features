...
const service = servicesData.find((s) => s.slug === "pump-repair")!;
const relatedProject = projectsData.find((p) => p.id === "fountain-pump-repair-anaheim");

export const metadata: Metadata = constructMetadata({
  title: `${service.title} | Orange County Water Feature Pump Installations`,
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 space-y-12">
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Why Professional Pump Sizing Matters</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Our Pump Service & Replacement Steps</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Common Pump Failure Signs</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-28 bg-navy-900 text-white p-6 sm:p-8 rounded-2xl border border-navy-800 shadow-xl space-y-6">
                <div className="flex items-center gap-2 text-xs font-bold text-aqua-400 uppercase tracking-wider">
                  ...
                  <span>Commercial & Submersible</span>
                </div>

                <h3 className="text-xl font-bold text-white leading-snug">
                  Need a Pump Diagnostic or Upgrade?
                </h3>

                <p className="text-xs sm:text-sm text-slate-300">
                  We install heavy-duty commercial and energy-efficient residential pumps matched to your head pressure.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <PhoneCallLink
                    locationLabel="sidebar-pump-repair"
