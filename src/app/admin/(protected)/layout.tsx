...
// Auth guard for every actual back-office page. Deliberately does NOT wrap
// /admin/login (see src/app/admin/layout.tsx) — that route lives outside
// this route group specifically so an unauthenticated visitor redirected
// here by requireAdmin() can render the login page instead of looping back
