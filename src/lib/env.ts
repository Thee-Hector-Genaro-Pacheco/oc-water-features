...
export const serverEnvSchema = z.object({
  ...
  BUSINESS_NOTIFICATION_EMAIL: z.string().email("BUSINESS_NOTIFICATION_EMAIL must be a valid email").default("info@ocwaterfeatures.com"),
  ADMIN_NOTIFICATION_EMAIL: z.string().email("ADMIN_NOTIFICATION_EMAIL must be a valid email").default("admin@ocwaterfeatures.com"),
...
export function getServerEnv(): ServerEnv {
  ...
  if (!parseResult.success) {
    ...
    return {
      BUSINESS_NOTIFICATION_EMAIL: process.env.BUSINESS_NOTIFICATION_EMAIL || "info@ocwaterfeatures.com",
      ADMIN_NOTIFICATION_EMAIL: process.env.ADMIN_NOTIFICATION_EMAIL || "admin@ocwaterfeatures.com",
